  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        if (result.success) {
          toast.success("Login successful! Welcome back to Travel Diary!", {
            position: "top-right",
            autoClose: 3000,
      ...
      <div className="travel-section">
        <div className="travel-content">
          <img
            src={travelLogo}
            alt="Travel Diary Logo"
            className="travel-logo-large"
          />
          <p className="travel-subtitle">
            Welcome back to your travel community. Continue sharing your
            adventures and discovering new destinations.
          </p>
